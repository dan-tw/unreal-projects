...
unrealRootPath=/media/dan/storage/unreal/source/4.27
DrivingCxxRootPath=/home/dan/Documents/Unreal Projects/DrivingCxx

gameProjectFile=/home/dan/Documents/Unreal Projects/DrivingCxx/DrivingCxx.uproject
...
include(DrivingCxxSource.pri)
include(DrivingCxxHeader.pri)
include(DrivingCxxConfig.pri)
include(DrivingCxxIncludes.pri)
include(DrivingCxxDefines.pri)

DrivingCxx-Linux-Debug.commands = $$build DrivingCxx Linux Debug  -project="\"$$gameProjectFile\"" $$args
DrivingCxx-Linux-DebugGame.commands = $$build DrivingCxx Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
DrivingCxx-Linux-Shipping.commands = $$build DrivingCxx Linux Shipping  -project="\"$$gameProjectFile\"" $$args
DrivingCxx-Linux-Test.commands = $$build DrivingCxx Linux Test  -project="\"$$gameProjectFile\"" $$args
DrivingCxx.commands = $$build DrivingCxx Linux Development  -project="\"$$gameProjectFile\"" $$args

DrivingCxxEditor-Linux-Debug.commands = $$build DrivingCxxEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
DrivingCxxEditor-Linux-DebugGame.commands = $$build DrivingCxxEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
DrivingCxxEditor-Linux-Shipping.commands = $$build DrivingCxxEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
DrivingCxxEditor-Linux-Test.commands = $$build DrivingCxxEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
DrivingCxxEditor.commands = $$build DrivingCxxEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	DrivingCxx-Linux-Debug \
	DrivingCxx-Linux-DebugGame \
	DrivingCxx-Linux-Shipping \
	DrivingCxx-Linux-Test \
	DrivingCxx \
	DrivingCxxEditor-Linux-Debug \
	DrivingCxxEditor-Linux-DebugGame \
	DrivingCxxEditor-Linux-Shipping \
	DrivingCxxEditor-Linux-Test \
	DrivingCxxEditor \
